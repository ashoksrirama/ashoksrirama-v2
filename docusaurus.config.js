...
const config = {
  ...
  organizationName: 'ashoksrirama', // Usually your GitHub org/user name.
  projectName: 'ashoksrirama', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {to: '/reinvent', label: 'reInvent', position: 'left'},
          {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              ...
              {
                label: 'LinkedIn',
                href: 'https://www.linkedin.com/in/ashok-srirama/',
              },
              {
                label: 'Twitter',
                href: 'https://twitter.com/ashoksrirama',
              },
            ],
          },
          {
